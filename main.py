...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        b2.place(x=450,y=100,width=180, height=180)
        ...
        b2_2.place(x=450,y=280,width=180,height=30)
        ...
        b3_3.place(x=700,y=280,width=180,height=30)
        ...
        b4_4.place(x=950,y=280,width=180,height=30)
