...
class Register:
    def __init__(self,root):
        ...
        regis_lbl=Label(frame,text="Admin REGISTER HERE",font=("times new roman",22,"bold"),bg="white",fg="darkgreen")
    ...
    def register_data(self):
        ...
        if self.var_fname.get()=="":
            ...
            if row!=None:
                ...
                my_cursor.execute("insert into admin_register values(%s,%s,%s,%s,%s,%s,%s)",(
